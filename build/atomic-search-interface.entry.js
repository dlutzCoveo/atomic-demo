import { r as registerInstance, e as getAssetPath, h, g as getElement } from './index-0cff3bd2.js';
import { o as od, e as bd, A as Ad, Q as Qi, n as nc, f as ff, M as Ml } from './headless.esm-41df7a7c.js';
import { c as createCommonjsModule, a as commonjsGlobal, b as commonjsRequire } from './_commonjsHelpers-2f226e38.js';
...
const AtomicSearchInterface = class {
  ...
  updateSearchConfiguration() {
    var _a;
    (_a = this.engine) === null || _a === void 0 ? void 0 : _a.dispatch(od.updateSearchConfiguration({
  ...
  async initialize(options) {
    if (this.engine) {
      this.engine.logger.warn('The atomic-search-interface component "initialize" has already been called.', this.host);
      return;
    }
  ...
  async executeFirstSearch() {
    if (!this.engine) {
      console.error('You have to call "initialize" on the atomic-search-interface component before executing a search.', this.host);
      return;
    }
    if (!this.initialized) {
    ...
    this.engine.dispatch(bd.executeSearch(Ad.logInterfaceLoad()));
  }
  initEngine(options) {
    try {
      this.engine = new Qi({
        configuration: Object.assign(Object.assign({}, options), { search: {
            searchHub: this.searchHub,
            pipeline: this.pipeline,
          } }),
        reducers: nc,
  ...
  initComponents() {
    this.hangingComponentsInitialization.forEach((event) => event.detail(this.bindings));
  }
  initSearchParameterManager() {
    if (this.reflectStateInUrl) {
      ...
      const { serialize, deserialize } = ff();
      const params = deserialize(decodedState);
      const manager = Ml(this.engine, {
  ...
  render() {
    ...
    return [
      this.engine && (h("atomic-relevance-inspector", { bindings: { engine: this.engine, i18n: this.i18n } })),
      h("slot", null),
    ];
  }
